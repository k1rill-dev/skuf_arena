...
const ChooseTicket = ({concert, tickets, setTickets}) => {
    const [zoneInfo, setZoneInfo] = useState(null);

    const handleZoneClick = (zone, price, id) => {
        setZoneInfo({zone, price, id});
    };
        ...
        <div className="flex flex-col justify-center items-center w-100">
            {concert.prices.map((item) => (
                <div
                    ...
                    onClick={() => handleZoneClick(item.place, item.price, item.id)}
                >
