      ...
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        <div className="text-gray-800 text-xl font-bold flex items-center">
          <svg className="h-6 w-6 mr-2" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M12 0C5.373 0 0 5.372 0 12c0 2.815 1.003 5.403 2.678 7.438L12 24l9.322-4.562C22.996 17.403 24 14.814 24 12c0-6.628-5.373-12-12-12zM5 12c0-1.939.532-3.747 1.45-5.291l7.841 7.842V12H5zm7 7.991L6.009 11H19l-5 5v4.991zM12 6.009L16.991 11H7.008L12 6.009z" fill="currentColor"/>
          </svg>
          Скуф Арена
        </div>
